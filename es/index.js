...
import { Schema, Mixed, copyInstance, GridFSBucket, MongooseTypes, toCollectionName, model } from '@lykmapipo/mongoose-common';
export { GridFSBucket } from '@lykmapipo/mongoose-common';
...
export { DEFAULT_BUCKET_CHUNK_SIZE, DEFAULT_BUCKET_MODEL_NAME, DEFAULT_BUCKET_NAME, DEFAULT_BUCKET_OPTIONS, createBucket, createModel };
