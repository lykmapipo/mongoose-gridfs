 ...
 * const writeStream = bucket.openWriteStream({_id, filename});
 ...
 * const readStream = bucket.openReadStream({_id, filename});
 * readStream.pipe(writeStream);
 */
...
/* TODO export them */
/* statics */
GridFSBucket.DEFAULT_BUCKET_NAME = DEFAULT_BUCKET_NAME;
GridFSBucket.DEFAULT_BUCKET_MODEL_NAME = DEFAULT_BUCKET_MODEL_NAME;
GridFSBucket.DEFAULT_BUCKET_CHUNK_SIZE = DEFAULT_BUCKET_CHUNK_SIZE;
GridFSBucket.DEFAULT_BUCKET_OPTIONS = DEFAULT_BUCKET_OPTIONS;
