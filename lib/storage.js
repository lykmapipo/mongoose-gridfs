...
GridFSStorage.prototype.findOne = function (options, done) {
  ...
  this.storage.find(options, function (error, cursor) {
...
GridFSStorage.prototype.readById = function (id, done) {
  ...
  //TODO allow pass openDownloadStream options
  const stream = this.storage.openDownloadStream(options._id);
...
GridFSStorage.prototype.readByFileName = function (filename, done) {
  ...
  //create a readable stream for a specific file
  //TODO support openDownloadStreamByName options
  const stream = this.storage.openDownloadStreamByName(options.filename);
